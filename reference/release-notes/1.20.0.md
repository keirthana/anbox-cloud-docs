...
* The [`instance-type` attribute](https://discourse.ubuntu.com/t/24197#instance-type-1) is deprecated now. You can use the `resources` attribute to specify any custom resource requirements.
