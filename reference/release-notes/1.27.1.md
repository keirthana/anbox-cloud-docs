...
* Earlier accessing the ADB daemon from inside the Android container was not limited or prevented, which poses a threat. To avoid abuse, access is limited to the ADB Daemon TCP ports for privileged user ids (e.g. root). The ADB bridge will still have access.<!--AC-3368-->
