...
* Support for Ubuntu 20.04 (focal) is deprecated with this release and is planned to be removed in Anbox Cloud 1.24.0.
* Support for the EmuGL renderer is planned to be removed in Anbox Cloud 1.23.0.
