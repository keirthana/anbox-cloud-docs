...
The Anbox Cloud dashboard has the following improvements:
  ...
  * You can set up and authorise ADB connections for an instance from the dashboard.
...
The Anbox vendor images are now based on Android 14. Building on the latest version of Android helps us provide the latest updates and security fixes.
...
* In some rare cases, the VHAL panel will not show up on AAOS streams. Reloading the stream page fixes the issue in most cases. In case it doesn't, restarting the instance will fix the issue.
