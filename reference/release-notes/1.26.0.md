...
This release announces the following deprecations. See {ref}`ref-deprecation-notes` for information about when they will become unsupported.

* [AMS node controller charm](https://charmhub.io/ams-node-controller).
...
* Unable to stream an instance after deploying the regular Anbox Cloud using Juju([2110194](https://bugs.launchpad.net/anbox-cloud/+bug/2110194)). This issues exists since the 1.25.0 release.
