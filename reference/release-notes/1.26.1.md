...
Anbox Cloud 1.26.1 is a minor release. To understand minor and patch releases, see [Release notes](https://documentation.ubuntu.com/anbox-cloud/en/latest/reference/release-notes/release-notes).
...
* Android security updates for June 2025 (see [Android Security Bulletin - June 2025](tbd)).
* The Android WebView has been updated to [137.0.7151.61](https://chromereleases.googleblog.com/2025/05/chrome-for-android-update_0122535239.html).<!--AC-3316-->
...
* [LP 2112098](https://bugs.launchpad.net/anbox-cloud/+bug/2112098) While upgrading to 1.26.0 from 1.25.2, the dashboard displays the error `Ubuntu Pro token is not attached` even when the Ubuntu Pro token is already attached.
...
* [LP 2106114](https://bugs.launchpad.net/anbox-cloud/+bug/2106114) When you attempt to rotate the screen from portrait to landscape during Android runtime, there is no error observed but the screen does not rotate for AOSP images. It works as expected for AAOS images, though.<!--AC-3370-->
